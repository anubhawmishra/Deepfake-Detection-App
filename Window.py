...
image2 =Image.open('f4.jpg')
image2 =image2.resize((850,890),)
...
lbl = tk.Label(frame_alpr, text="Deep fake Detection", font=('Times New Roman', 30,' bold '),bg="white",fg="black")
...
logo_label1=tk.Label(text='To develop a system that capable \n Identify the type of Deep fake...',compound='bottom',font=("Times New Roman", 20, 'bold', 'italic'),width=35, bg="white", fg="black")
